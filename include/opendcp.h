...
/* library information */
#define OPENDCP_NAME       "OpenDCP"
#define OPENDCP_VERSION    "0.30.0"
#define OPENDCP_COPYRIGHT  "(c) 2010-2014 Terrence Meiczinger. All rights reserved."
#define OPENDCP_LICENSE    "The program is provided AS IS with NO WARRANTY OF ANY KIND, INCLUDING THE WARRANTY OF DESIGN, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n\nDedicated in memory of James Meiczinger"
#define OPENDCP_URL        "http://www.opendcp.org"
